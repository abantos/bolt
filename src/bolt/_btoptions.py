...
class Options:
    ...
    def _build_parser(self):
        ...
        parser.add_argument(
            OptionSwitch.BOLTFILE_SHORT,
            OptionSwitch.BOLTFILE_LONG,
            default=Default.BOLTFILE,
            help='Bolt file containing the configuration and task. The default is "boltfile.py"',
        )
        parser.add_argument(
            OptionSwitch.LOG_LEVEL_SHORT,
            OptionSwitch.LOG_LEVEL_LONG,
            default=Default.LOG_LEVEL,
            help="Specifies logging level.",
        )
        parser.add_argument(
            OptionSwitch.LOG_FILE_SHORT,
            OptionSwitch.LOG_FILE_LONG,
            default=None,
            help="Log file to write the output.",
        )
        parser.add_argument(
            OptionSwitch.CONTINUE_ON_ERROR_LONG,
            action="store_true",
            help="Continue executing even if errors are found",
        )
        parser.add_argument(
            OptionSwitch.VERSION_LONG,
            action="store_true",
